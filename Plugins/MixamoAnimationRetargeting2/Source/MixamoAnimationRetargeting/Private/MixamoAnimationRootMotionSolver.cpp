...
void FMixamoAnimationRootMotionSolver::LaunchProcedureFlow(USkeleton* Skeleton)
{
    ...
    if (!ResultAnimation)
    {
        UE_LOG(LogMixamoToolkit, Error, TEXT("Aborted: failed to duplicate the animation sequence."));
        return;
    }
...
bool FMixamoAnimationRootMotionSolver::ExecuteExtraction(UAnimSequence* AnimSequence, const UAnimSequence* InPlaceAnimSequence)
{
    ...
    if (!HipsBoneTrack)
    {
        UE_LOG(LogMixamoToolkit, Error, TEXT("Hips bone not found in the ordinary animation sequence."));
        return false;
    }
    ...
    {
        UE_LOG(LogMixamoToolkit, Error, TEXT("Hips bone not found in the inplace animation sequence."));
        return false;
    }
    ...
    {
        UE_LOG(LogMixamoToolkit, Error, TEXT("Track data keys number mismatch between ordinary and inplace animation sequences."));
        return false;
    }
    ...
    {
        UE_LOG(LogMixamoToolkit, Error, TEXT("Invalid track key data on ordinary animation sequence, expected uniform data."));
        return false;
    }
    ...
    {
        UE_LOG(LogMixamoToolkit, Error, TEXT("Invalid track key data on inplace animation sequence, expected uniform data."));
        return false;
    }
